...
$(function () {
    app = {
        ...
        validePage: function (page) {
            const pages = ["index","bebidas","caipirinha","suco","coquetel","sobremesas","mousse","pave","baklava","macarrao","lasanha","empadao","picanha","frango","tilapia","massas","carnes","info","contatos"];
